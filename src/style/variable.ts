...
export const DESIGN_SYSTEM_TEXT: Record<string, Pick<CSSProperties, "fontSize" | "fontWeight" | "lineHeight" | "letterSpacing">> = {
  heading24Bold: {
    fontSize: "2.4rem",
    fontWeight: "700",
    lineHeight: "150%",
...
type NestedColor = Record<string, Color>;

export const DESIGN_SYSTEM_COLOR: Record<string, Color | NestedColor> = {
  gray: {
    "00": "#FFFFF",
    "100": "#F2F4F8",
    "200": "#EDF0F4",
