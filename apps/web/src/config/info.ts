...
이 약관은 Layer (이하 '회사' 라고 합니다)가 제공하는 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
...
제4조(약관의 효력과 변경)
1. 이 약관은 Layer(이)가 제공하는 모든 인터넷서비스에 게시하여 공시합니다. '회사'는 ‘전자상거래 등에서의 소비자보호에 관한 법률(이하 '전자상거래법'이라 함)', '약관의 규제에 관한 법률(이하 '약관규제법'이라 함)', '전자문서 및 전자거래 기본법(이하 '전자문서법'이라 함)', ‘전자금융거래법 ‘, '정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법'이라 함)', '소비자기본법' 등 관계 법령(이하 '관계법령' 이라 함)에 위배되지 않는 범위 내에서 이 약관을 변경할 수 있으며, 회사는 약관이 변경되는 경우에 변경된 약관의 내용과 시행일을 정하여, 그 시행일로부터 최소 7일 (이용자에게 불리하거나 중대한 사항의 변경은 30일) 이전부터 시행일 후 상당한 기간 동안 공지하고, 기존 이용자에게는 변경된 약관, 적용일자 및 변경사유(변경될 내용 중 중요사항에 대한 설명을 포함)를 별도의 전자적 수단(전자우편, 문자메시지, 서비스 내 전자쪽지발송, 알림 메시지를 띄우는 등의 방법)으로 개별 통지합니다. 변경된 약관은 공지하거나 통지한 시행일로부터 효력이 발생합니다.
...
3. 회사가 제공하는 서비스의 내용은 다음과 같습니다.
    1. 회고에 대한 가이드를 제공하고, 회고에 대한 분석을 통해 성장을 돕는 서비스
...
부 칙
제1조(시행일)
본 약관은 2024.08.10.부터 시행됩니다.

문의 및 연락
📪 e-mail : xwdpmlayer@gmail.com`,
  privacyPolicy: `
개인정보처리방침

제1조(목적)
Layer(이하 ‘회사'라고 함)는 회사가 제공하고자 하는 서비스(이하 ‘회사 서비스’)를 이용하는 개인(이하 ‘이용자’ 또는 ‘개인’)의 정보(이하 ‘개인정보’)를 보호하기 위해, 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법') 등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 ‘본 방침’)을 수립합니다.
...
1. 회사는 이용자의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기 위하여 아래와 같이 관련 부서 및 개인정보 보호 책임자를 지정하고 있습니다.
    1. 개인정보 보호 책임자
        1. 성명: 김현우
        2. 직책: 개발책임자
        3. 전화번호: 010-3747-4646
        4. 이메일: gentlemonster77@likelion.org
...
제1조 본 방침은 2024.08.10.부터 시행됩니다.
    `,
  marketingConsent: `마케팅 활용 및 광고 수신 동의

Layer(이하 '회사')는 개인정보보호법 제22조 및 정보통신망 이용촉진 및 정보보호 등에 관한 법률 제50조에 따라, 마케팅 및 광고성 정보 전송을 위한 개인정보의 수집·이용에 대해 아래와 같이 안내하고 이용자의 동의를 받습니다.

제1조(개인정보의 수집·이용 목적)
회사는 다음 각 호의 목적으로 이용자의 개인정보를 수집·이용합니다.
1. 신규 기능, 서비스 개편 및 업데이트 등 서비스 관련 정보의 안내
2. 이벤트, 프로모션, 제휴 혜택 등 광고성 정보의 제공 및 참여 기회의 안내
3. 이용자의 서비스 이용 이력에 기반한 회고 템플릿·콘텐츠 등 맞춤형 정보의 추천 및 제공
4. 서비스 이용 통계 및 이용 행태 분석을 통한 마케팅 활동의 기획·개선
5. 설문조사, 사용자 인터뷰 등 이용자 의견 수렴 활동의 안내

제2조(수집·이용하는 개인정보의 항목)
1. 필수 항목: 이메일 주소, 이름 및 닉네임
2. 자동 수집 항목: 서비스 이용 기록, 접속 로그, 쿠키, 기기 정보 및 푸시 알림 토큰
3. 회사는 본 동의를 근거로 주민등록번호 등 고유식별정보나 민감정보를 수집하지 않습니다.

제3조(광고성 정보의 전송 수단)
1. 회사는 전자우편(E-mail), 애플리케이션 푸시 알림, 서비스 내 알림을 통해 광고성 정보를 전송합니다.
2. 회사가 위 각 호 외의 전송 수단을 추가하고자 하는 경우, 사전에 그 사실을 안내하고 필요한 경우 별도의 동의를 받습니다.

제4조(개인정보의 보유 및 이용 기간)
1. 회사는 이용자가 본 동의를 철회하거나 회원에서 탈퇴하는 시점까지 제1조의 목적 범위에서 개인정보를 보유·이용합니다.
2. 전항에도 불구하고 관계 법령에 따라 보존할 필요가 있는 경우 해당 법령에서 정한 기간 동안 보관합니다.
3. 회사는 정보통신망법 시행령에 따라 동의를 받은 날부터 2년마다 이용자의 광고성 정보 수신 동의 여부를 확인합니다.

제5조(광고성 정보 전송 시간)
회사는 오후 9시부터 다음 날 오전 8시까지의 시간에는 광고성 정보를 전송하지 않습니다. 다만 해당 시간대의 전송에 대하여 이용자로부터 별도의 사전 동의를 받은 경우에는 그러하지 아니합니다.

제6조(개인정보의 제3자 제공 및 처리위탁)
1. 회사는 본 동의를 근거로 이용자의 개인정보를 제3자에게 제공하지 않습니다. 제3자 제공이 필요한 경우 제공받는 자, 제공 목적, 제공 항목 및 보유 기간을 고지하고 별도의 동의를 받습니다.
2. 회사는 광고성 정보의 발송 및 통계 분석을 위하여 업무의 일부를 외부 전문업체에 위탁할 수 있으며, 이 경우 위탁 사실과 수탁자를 개인정보처리방침을 통해 공개합니다.

제7조(동의 거부 권리 및 불이익)
이용자는 본 동의를 거부할 권리가 있습니다. 본 동의는 선택 사항이므로, 동의하지 않더라도 회원가입 및 회사가 제공하는 서비스의 이용에는 어떠한 제한이나 불이익도 없습니다. 다만 동의하지 않는 경우 제1조에 따른 혜택 및 정보를 안내받지 못할 수 있습니다.

제8조(동의의 철회)
1. 이용자는 언제든지 본 동의를 철회할 수 있습니다.
2. 철회는 서비스 내 설정 화면, 수신한 광고성 정보에 표시된 수신거부 수단, 또는 제9조의 문의처를 통해 요청할 수 있습니다.
3. 회사는 철회 요청을 접수한 즉시 광고성 정보의 전송을 중단하고, 그 처리 결과를 이용자에게 알립니다.
4. 본 동의를 철회하더라도 이용약관 변경, 서비스 점검 등 이용자가 반드시 알아야 하는 사항에 대한 안내는 계속 발송될 수 있습니다.
...
부칙
제1조 본 동의서는 2026.08.01.부터 시행됩니다.`,
};
