      ...
      >
        ...
        >
          ...
          >
            ...
            {goodPoints === null || goodPoints.length === 0 ? (
              <EmptyState message="잘하고 있는 점이 없어요." />
            ) : (
              <div
                css={css`
                  display: flex;
          ...
          >
            ...
            {badPoints === null || badPoints.length === 0 ? (
              <EmptyState message="부족한 점이 없어요." />
            ) : (
              <div
                css={css`
                  display: flex;
          ...
          >
            ...
            {improvementPoints === null || improvementPoints.length === 0 ? (
              <EmptyState message="개선이 필요한 점이 없어요." />
            ) : (
              <div
                css={css`
                  display: flex;
